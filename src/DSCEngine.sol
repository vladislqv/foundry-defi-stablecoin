...
contract DSCEngine is ReentrancyGuard {
    ...
    error DSCEngine__CannotRedeemMoreThanDeposited();
    ...
    uint256 private constant LIQUIDATION_PRESITION = 100;
     ...
     * @notice this function will deposit your collateral and mint DSC tokens in one transaction
     */
     ...
     * @notice this function will redeem your collateral and burn DSC tokens in one transaction
     */
    ...
    /**
     * @notice the user's health factor must be below the minimum health factor
        ...
        nonReentrant
    {
        ...
        uint256 bonusCollateral = (tokenAmountFromDebtCovered * LIQUIDATION_BONUS) / LIQUIDATION_PRESITION;
        ...
        private
    {
        if(s_collateralDeposited[from][tokenCollateralAddress] < amountCollateral) {
            revert DSCEngine__CannotRedeemMoreThanDeposited();
        }
     ...
     * If a user goes below 1, then he can get liquidated
    ...
    function _healthFactor(address user) private view returns (uint256) {
        ...
        uint256 collateralAdjustedForThreshold = (collateralValueInUsd * LIQUIDATION_THRESHOLD) / LIQUIDATION_PRESITION;
